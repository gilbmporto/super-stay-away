...
async function EditRentalPage({ params }: { params: { id: string } }) {
	...
	const defaultAmenities = JSON.parse(property.amenities) as Amenity[]
		...
		<section>
			...
			<div className="border p-8 rounded-lg">
				...
				<FormContainer action={updatePropertyAction}>
					...
					<TextAreaInput
						name="description"
						labelText="Description (10 - 1000 characters)"
					...
					<SubmitButton text="Update Property" className="mt-10" />
				</FormContainer>
			</div>
		</section>
	)
